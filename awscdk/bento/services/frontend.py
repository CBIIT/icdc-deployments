...
class frontendService:
  def createService(self, config):
    ...
    environment={
            "NEW_RELIC_APP_NAME":"{}-{}-frontend".format(config['main']['project'], config['main']['tier']),
            "NEW_RELIC_DISTRIBUTED_TRACING_ENABLED":"true",
            "NEW_RELIC_NO_CONFIG_FILE":"true",
            "NEW_RELIC_HOST":"gov-collector.newrelic.com",
            "REACT_APP_ABOUT_CONTENT_URL":config[service]['about_content_url'],
            "REACT_APP_LANDING_DATA":config[service]['react_app_landing_data'],
            "REACT_APP_NEWS_DATA":config[service]['react_app_news_data'],
            "REACT_APP_DMN_README":config[service]['react_app_readme_url'],
            "REACT_APP_FOOTER_PRIVACY_POLICY":config[service]['react_app_footer_privacy_policy'],
            "REACT_APP_GA_TRACKING_ID":config[service]['backend_google_analytics_id'],
            "REACT_APP_DATA_MODEL":config[service]['react_app_data_model'],
            "REACT_APP_DATA_MODEL_PROPS":config[service]['react_app_data_model_prop'],
            ...
            "REACT_APP_BACKEND_GETUSERINFO_API":config[service]['react_app_backend_getuserinfo_api'],
    ...
    secrets={
            ...
            "SUMO_COLLECTOR_TOKEN":ecs.Secret.from_secrets_manager(self.secret, 'sumo_collector_token_frontend'),
