    ...
    def __init__(self, scope: Construct, **kwargs) -> None:
        ...
        self.secret = secretsmanager.Secret(self, "Secret",
            ...
            secret_object_value={
                ...
                "cloudfront_key_pair_id": SecretValue.unsafe_plain_text(CFPublicKey.public_key_id),
                "cloudfront_domain": SecretValue.unsafe_plain_text("https://{}".format(self.cfDistribution.distribution_domain_name)),
